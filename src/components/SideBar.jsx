  ...
  return (
    <div className="col-span-3 mt-0 pt-0 border-r-[0.5px] border-gray-700 p-4 ml-32 align-middle">
      ...
      <div>
        ...
        <div />
        <button
          className="rounded-full w-full mt-2 font-bold bg-sky-500 align-middle justify-center px-4 py-3 hover:bg-sky-600 "
          onClick={() => {
            navigate("/write");
          }}
        >
        ...
        <div
          className="mt-28 gap-3  px-3 grid grid-cols-8 flex justify-start items-center rounded-full w-full  mt-2 font-bold bg-transparent justify-center hover:bg-slate-800"
          onClick={() => {
        ...
        >
          ...
          <div className="flex justify-between items-center col-span-6">
            <div className="py-2">
              ...
              <div className="text-slate-500">@{userId.substring(0, 6)}...</div>
            </div>
...
const Logout = ({ onClick, username }) => {
  return (
    <div>
      <div
        className="absolute bottom-28 rounded-3xl bg-black shadow-slate-300 w- hover:bg-slate-800 shadow-inner border-b-[1px] border-slate-100  px-8 py-5"
        onClick={onClick}
      >
